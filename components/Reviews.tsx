          ...
          <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
            ...
            <div className="text-lg leading-8">
              <p>
                ...
                These guys came out quickly, diagnosed the problem, and had it
                fixed in no time. My home is cool and comfortable again, and I
                couldn&apos;t be happier. Thanks for being the best aircon
